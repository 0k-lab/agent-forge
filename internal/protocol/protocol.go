...
const (
	...
	EvidenceReasonSourcePolicyInvalid    = "source_policy_invalid"
	EvidenceReasonRepositoryStateUnsafe  = "repository_state_unsafe"
	EvidenceReasonCloneFailed            = "clone_failed"
	EvidenceReasonFetchFailed            = "fetch_failed"
	EvidenceReasonBaseUnavailable        = "base_unavailable"
