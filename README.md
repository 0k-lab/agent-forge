...
```json
{"version":1,"listen":"127.0.0.1:18080","database":"/srv/forge/state/forge.db","owner_token_env":"FORGE_OWNER_TOKEN","recovery_interval":"1s","lease_poll_interval":"100ms","default_pool":"coding","lifecycle":{"lease_ttl":"30s","retry_base":"1s","max_attempts":3},"default_execution":{"plugin_id":"reference","environment":["PATH"],"plugin_timeout":"15m","check_timeout":"10m","git_timeout":"1m","cleanup_timeout":"10s","plugin_output_bytes":1048576,"check_output_bytes":2048,"git_output_bytes":1048576},"deployment_profiles":[{"version":1,"id":"staging","target":"staging-app","prepare":{"argv":["/srv/forge/deploy/prepare","staging"],"timeout":"2m"},"activate":{"argv":["/srv/forge/deploy/activate","staging"],"timeout":"30s"},"healthcheck":{"argv":["/srv/forge/deploy/healthcheck","staging"],"timeout":"10s"},"cleanup_policy":"restore_previous"}],"workers":[{"id":"worker-1","pool":"coding","token_env":"FORGE_WORKER_TOKEN","concurrency":2}],"repositories":[{"id":"agent-forge","default_branch":"main","worker_pool":"coding","deployment_profile":"staging","execution":{"plugin_id":"codex","environment":["PATH","CODEX_HOME","CODEX_BIN"],"plugin_timeout":"15m","check_timeout":"10m","git_timeout":"1m","cleanup_timeout":"10s","plugin_output_bytes":1048576,"check_output_bytes":2048,"git_output_bytes":1048576}}]}
```
